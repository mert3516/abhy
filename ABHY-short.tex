...
\end{equation}
We will see that the dimension of $Lie(n-1)$ is $(n-2)!$.  A possible basis%\footnote{Such a basis is also known as a Hall basis \cite{Hall:1950} and is also that introduced by \cite{DelDuca:1999rs}}
